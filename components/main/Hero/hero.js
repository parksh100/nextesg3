...
export default function Hero() {
  return (
    <section className="container px-5">
      ...
      <section className="grid gap-x-8 gap-y-14 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 mt-10">
        <div className="p-3 mx-2 shadow-xl hover:shadow-2xl">
          <div className="mb-4">
            <ImOffice size="2em" color="#e28743" />
          </div>
          <div className="text-lg font-bold mb-2">중소기업 특화서비스</div>
          <div className="text-sm text-gray-400">
            ESG MASTER의 서비스는 중소기업의 고유한 요구와 상황에 맞게
        ...
        <div className="p-3 mx-2 shadow-xl hover:shadow-2xl">
          <div className="mb-4">
            <ImFire size="2em" color="#e28743" />
          </div>
          <div className="text-lg font-bold mb-2">교육과 컨설팅</div>
          <div className="text-sm  text-gray-400">
            정보에 입각한 의사 결정의 힘을 믿습니다. 우리의 역할은 ESG 컨설팅을
        ...
        <div className="p-3 mx-2 shadow-xl hover:shadow-2xl">
          <div className="mb-4">
            <ImStatsDots size="2em" color="#e28743" />
          </div>
          <div className="text-lg font-bold mb-2">검증된 컨설팅 프로세스</div>
          <div className="text-sm  text-gray-400">
            ESG MASTER의 컨설팅 프로세스는 연구에 기반을 두고 있으며 업계
        ...
        <div className="p-3 mx-2 shadow-xl hover:shadow-2xl">
          <div className="mb-4">
            <ImEqualizer size="2em" color="#e28743" />
          </div>
          <div className="text-lg font-bold mb-2">맞춤형 전략수립</div>
          <div className="text-sm  text-gray-400">
            ESG MASTER는 각 사업이 고유하며 모든 경우에 적용되는 하나의 ESG
        ...
        <div className="p-3 mx-2 shadow-xl hover:shadow-2xl">
          <div className="mb-4">
            <ImGift size="2em" color="#e28743" />
          </div>
          <div className="text-lg font-bold mb-2">ESG보고서</div>
          <div className="text-sm  text-gray-400">
            ESG 이니셔티브에 대한 명확한 커뮤니케이션이 중요합니다. 전문적인 ESG
        ...
        <div className="p-3 mx-2 shadow-xl hover:shadow-2xl">
          <div className="mb-4">
            <ImRocket size="2em" color="#e28743" />
          </div>
          <div className="text-lg font-bold mb-2">지속적 관리</div>
          <div className="text-sm  text-gray-400">
            ESG는 일회성 작업이 아니라 지속적인 여정입니다. ESG MASTER의
